...
open class HFBaseDestination: Hashable, Equatable {
    ...
    open var minLevel = HFSwiftyBeaver.Level.verbose
    ...
    open func send(_ level: HFSwiftyBeaver.Level, msg: String, thread: String, file: String,
    ...
    func formatMessage(_ format: String, level: HFSwiftyBeaver.Level, msg: String, thread: String,
    ...
    func messageToJSON(_ level: HFSwiftyBeaver.Level, msg: String,
    ...
    func levelWord(_ level: HFSwiftyBeaver.Level) -> String {
    ...
    func colorForLevel(_ level: HFSwiftyBeaver.Level) -> String {
        var color = ""
    ...
    func shouldLevelBeLogged(_ level: HFSwiftyBeaver.Level, path: String,
        ...
        let filterCheckResult = HFFilterValidator.validate(input: .init(filters: self.filters, level: level, path: path, function: function, message: message))
...
public func == (lhs: HFBaseDestination, rhs: HFBaseDestination) -> Bool {
