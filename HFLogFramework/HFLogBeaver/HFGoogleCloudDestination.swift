//
//  HFGoogleCloudDestination.swift
//  HFLogBeaver
//
...
public final class HFGoogleCloudDestination: HFBaseDestination {
    ...
    override public func send(_ level: HFSwiftyBeaver.Level, msg: String, thread: String,
...
extension HFSwiftyBeaver.Level {
