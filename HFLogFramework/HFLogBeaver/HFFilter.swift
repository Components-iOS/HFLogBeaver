...
public protocol FilterType : AnyObject {
    ...
    func reachedMinLevel(_ level: HFSwiftyBeaver.Level) -> Bool
}
...
public class Filter {
    ...
    let required: Bool
    let minLevel: HFSwiftyBeaver.Level

    public init(_ target: Filter.TargetType, required: Bool, minLevel: HFSwiftyBeaver.Level) {
    ...
    public func reachedMinLevel(_ level: HFSwiftyBeaver.Level) -> Bool {
...
public class CompareFilter: Filter, FilterType {
    ...
    override public init(_ target: Filter.TargetType, required: Bool, minLevel: HFSwiftyBeaver.Level) {
...
public class FunctionFilterFactory {
    public static func startsWith(_ prefixes: String..., caseSensitive: Bool = false,
                                  required: Bool = false, minLevel: HFSwiftyBeaver.Level = .verbose) -> FilterType {
    ...
    public static func custom(required: Bool = false, minLevel: HFSwiftyBeaver.Level = .verbose, filterPredicate: @escaping (String) -> Bool) -> FilterType {
