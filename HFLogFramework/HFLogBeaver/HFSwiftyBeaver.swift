...
open class HFSwiftyBeaver {
    ...
    public private(set) static var destinations = Set<HFBaseDestination>()
    ...
    @discardableResult
    open class func addDestination(_ destination: HFBaseDestination) -> Bool {
    ...
    /// returns boolean about success
    @discardableResult
    open class func removeDestination(_ destination: HFBaseDestination) -> Bool {
        return queue.sync(flags: DispatchWorkItemFlags.barrier) {
    ...
    open class func custom(level: HFSwiftyBeaver.Level,
    ...
    class func dispatch_send(level: HFSwiftyBeaver.Level,
                             message: @autoclosure () -> Any,
                             thread: String,
                             file: String,
                             function: String,
...
extension HFSwiftyBeaver.Level: Sendable {}
