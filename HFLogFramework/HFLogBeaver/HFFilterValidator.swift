...
struct HFFilterValidator {
    ...
    struct Input {
        ...
        let level: HFSwiftyBeaver.Level
        let path: String
        let function: String
        let message: String?
    }
    ...
    private static func filterMatchesCondition(_ filter: FilterType, level: HFSwiftyBeaver.Level, path: String, function: String, message: String?) -> Bool {
            let passes: Bool
    ...
    private static func filterMatchesMinLogLevel(_ filter: FilterType, level: HFSwiftyBeaver.Level) -> Bool {
