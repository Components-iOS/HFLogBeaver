...
open class HFConsoleDestination: HFBaseDestination {
    ...
    override open func send(_ level: HFSwiftyBeaver.Level, msg: String, thread: String,
    ...
    private func _logger(message: String, level: HFSwiftyBeaver.Level, subsystem: String, category: String) {
#if canImport(OSLog)
